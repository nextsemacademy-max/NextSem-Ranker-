# NextSem-Ranker-
Official repository for NextSem Ranker: A comprehensive study resource and codebase for Indian Sarkari Naukri and teaching exam preparation covering Quant, Reasoning, English, GK, Current Affairs, and Computer Basics.
# NextSem Ranker 🎯

Welcome to the official repository for NextSem Ranker, your ultimate companion for cracking Indian government teaching exams (CTET, State TETs, TGT, PGT, KVS, DSSSB, and more). 
...
1. Go to **Repository Settings** ➔ **Pages** (`https://github.com/nextsemacademy-max/NextSem-Ranker-/settings/pages`).
2. Under **Build and deployment** ➔ **Source**, select **Deploy from a branch**.
3. Under **Branch**, select `main` and folder `/ (root)`.
4. Click **Save**. Within 1–2 minutes, your web application will be live at `https://nextsemacademy-max.github.io/NextSem-Ranker-/`.
